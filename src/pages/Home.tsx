        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 mb-8">
            <div className="flex items-center gap-2 text-gray-400">
              <Mail size={20} />
              <a href="mailto:srijan4446@gmail.com?subject=Portfolio Inquiry&body=Hi Srijan," className="hover:text-orange-500 transition-colors">
          ...
          <div className="flex justify-center gap-6">
            <a href="https://github.com/Srijan339" target="_blank" rel="noopener noreferrer" 
               className="social-icon-link">
              <Github size={24} />
            </a>
            <a href="https://www.linkedin.com/in/srijan-k-1459941ba" target="_blank" rel="noopener noreferrer" 
               className="social-icon-link">
              <Linkedin size={24} />
            </a>
            <a href="mailto:srijan4446@gmail.com?subject=Portfolio Inquiry&body=Hi Srijan," 
               className="social-icon-link">
              <Mail size={24} />
            </a>
            <a href="https://www.instagram.com/srijan__3" target="_blank" rel="noopener noreferrer" 
               className="social-icon-link">
              <Instagram size={24} />
            </a>
          </div>
